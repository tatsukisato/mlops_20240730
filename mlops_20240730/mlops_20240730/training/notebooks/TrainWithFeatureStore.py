...
# ``mlops_20240730/resources/model-workflow-resource.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-mlops_20240730-experiment",
...
dbutils.widgets.text(
    "model_name", "dev.mlops_20240730.mlops_20240730-model", label="Full (Three-Level) Model Name"
)

# Pickup features table name
dbutils.widgets.text(
    "pickup_features_table",
    "dev.mlops_20240730.trip_pickup_features",
...
dbutils.widgets.text(
    ...
    "dev.mlops_20240730.trip_dropoff_features",
